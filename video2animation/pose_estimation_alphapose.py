...
def pose_estimate(video_path):
    args = {}
    args['cfg'] = "D:\\vsl\\configs\\halpe_136\\resnet\\256x192_res50_lr1e-3_2x-regression.yaml"
    args['checkpoint'] = "D:\\vsl\\pretrained_models\\halpe136_fast50_regression_256x192.pth"
    args['sp'] = False
    args['detector'] = "yolo"
    args['detfile'] = ""
    args['inputpath'] = ""
    ...
    output_folder = osp.join(env.ALPHAPOSE_OUTPUT_KEYPOINT, vid_name)
    ...
    try:
        for i in im_names_desc:
            ...
            with torch.no_grad():
                ...
                hm = hm.cpu()
                print("process save keypoints alphapose")
